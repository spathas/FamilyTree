...
public class Family {
    ...
    //Functions
    private Family findFamily(Person person) {

        if( person.getName().equals(parents[0].getName()) || person.equals(parents[1]) ) return this;
//        for(Person child : children)
//            if(person == child) return this;
        return null;
    }
    ...
    public static void isParent(Person firstPerson, Person lastPerson, String rel, ArrayList<Family> families) {
        if(rel.equals("father") || rel.equals("mother")) {
            ...
            for(Family fam: families) {
                ...
                specificFamily = fam.findFamily(firstPerson);
            }
