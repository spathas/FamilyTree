...
public class DataManager {
    ...
    private static void insertChild(ArrayList<Relationship> relationships, ArrayList<Family> families, Relationship rel, String parentType) {
    ...
    public static void checkForCompletedFamily(ArrayList<Relationship> relationships, ArrayList<Family> families) {
        for (Relationship rel : relationships) {
            if(rel.getRelationship().equals("mother"))
                insertChild(relationships, families, rel, "father");
            if(rel.getRelationship().equals("father"))
                insertChild(relationships, families, rel, "mother");
        }
    ...
    public static void main(String[] args) {
        ...
        checkForCompletedFamily(relationships, families);
